...
const Notifications: React.FC<NotificationsProps> = ({ openNotifications, setOpenNotifications }) => {
    ...
    return (
        <div className={`bg-[#1a1813] rounded absolute z-50 top-1 md:right-10 w-full md:w-80 min-h-[400px] ${openNotifications ? 'flex flex-col' : 'hidden'}`} ref={notificationsRef}>
            {
                loading ?
                    <div className="flex justify-center items-center h-96"> <p className="text-white">
                        <RotatingLines strokeColor='#cabfa3' width='50' />
                    </p>
                    </div>
                    :
                                ...
                                <div className="flex justify-between">
                                    <div className="flex items-center gap-4">
                                        <div className="bg-[#3c3b5c] rounded-full min-w-[32px] h-8 flex items-center justify-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#cabfa3]" fill="none" viewBox="0 0 24 24" stroke="currentColor">

  ...
  const BannerContent: BannerProps[] = [
    {
      ...
      right: (
        <div>
          <img src="/images/crashTitle.svg" alt="upgrade" />
        </div>
      ),
    },
    {
    ...
    },
    {
      ...
      right: (
        <div className="hidden 2xl:flex 2xl:mr-36">
          <img src="/images/crixusCrest.svg" alt="kanicasino" />
        </div>
      ),
    },
  ];

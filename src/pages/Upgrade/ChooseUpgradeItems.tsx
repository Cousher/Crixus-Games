  ...
  const { t } = useTranslation();
    ...
    return (
        <div className="flex flex-col md:w-1/2 gap-2 ">
            <div className="flex w-full items-center justify-between bg-[#221d16] rounded px-6 h-24">
                <span>{t("games.getOneItem")}</span>
                    ...
                    loadingItems ? (
                        ...
                        selectedCase === null ? (
                            ...
                            selectedCaseItems.map((item: any, index: number) => {
                                return (
                                    <div key={index} className={`cursor-pointer border-2 h-min ${selectedTarget?._id === item._id ? ' border-[#e0b341]' : 'border-transparent'}`} onClick={() => {

                    ...
                    return (
                        <div key={index} id="prize" className={`animate-fade-in relative flex `}>
                            ...
                            {animationAux2 && openedItems.length == 1 && (
                                ...
                                >
                                    <div
                                        className={`notched h-[184px] w-[184px] transition-all bg-[#0e0e12] z-30 flex flex-col items-center justify-center`}
                                    >
                                        <span className="text-xl font-bold color-[#e7ddc8] text-center">
                                            {openedItem.name}
                                        </span>
                                        <span

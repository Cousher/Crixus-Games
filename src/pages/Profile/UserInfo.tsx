...
const UserInfo: React.FC<UserProps> = ({
  ...
  return (
      ...
      <div className="flex flex-col lg:flex-row items-center gap-7">
        <div className="relative group">
          ...
          {isSameUser && (
            ...
            >
              <span className="text-white">{t("profile.itsYou")}</span>
            </button>
          )}
          <input
            type="file"
        ...
        <div className="flex flex-col w-80 md:w-[686px]">
          <div className="flex gap-4 items-center"> <span className="text-2xl font-semibold color-[#efe6cf]">
            {username}
          </span>
            {
          ...
          <div className="flex flex-col gap-2 mt-5">
            <div className="flex w-full">
              ...
              />{" "}
              <div
                className={`h-1 bg-[#3a2f14] rounded rounded-r-none -translate-x-1 z-0`}
                style={{
            ...
            <div className="flex w-full items-center justify-between">
              <span className="text-[#efe6cf] font-semibold">
    ...
    ${new Intl.NumberFormat("en-US", { maximumFractionDigits: 0 }).format(calculateRequiredXP(level))
              ...
              <span
                className="text-[#3a2f14] underline -translate-x-1 cursor-help"

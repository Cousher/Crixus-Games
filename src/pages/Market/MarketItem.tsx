...
const MarketItem: React.FC<Props> = ({ item }) => {
  ...
  return (
    <div className="border border-[#181410] rounded-lg p-4 bg-gradient-to-tr from-[#1a1410] to-[#141009] transition-all duration-500 ease-in-out w-[226px] h-[334px]">
      ...
      <p className="text-blue-500 text-center py-1 text-ellipsis truncate">
            {item.totalListings} {t("market.announced")}
      </p>
      <MainButton textSize="text-sm" text={`${t("market.startingAt")} ${new Intl.NumberFormat("en-US", {
          style: "currency",
          currency: "DOL",
